...
import com.example.parkingapp.timeFragments.TimePickerFragment;
...
public class AddReservation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String id = day + month + year + hours + minutes + parkingChosen;
    ...
    private void checkAvailability() {
        ...
        for (int i = 1; i < 5; i++) {
            String id = day + month + year + hours + minutes + String.valueOf(i);
